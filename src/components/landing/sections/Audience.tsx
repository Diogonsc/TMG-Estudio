        ...
        {AUDIENCE_ITEMS.map((it, i) => (
          <Reveal key={it.title} delay={i * 0.08}>
            <div className="group h-full rounded-3xl glass p-7 transition-all hover:-translate-y-2 hover:glow-purple">
              <span className="grid h-12 w-12 place-items-center rounded-2xl bg-[var(--gradient-purple)]/20 ring-1 ring-purple-neon/30 transition-colors group-hover:bg-[var(--gradient-purple)]">
